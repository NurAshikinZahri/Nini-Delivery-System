				...
				<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav menu__list">
					...
					<li class="dropdown menu__item menu__item--current">
						<a href="#" class="dropdown-toggle menu__link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Bouquet Types<span class="caret"></span></a>
							<ul class="dropdown-menu multi-column columns-3">
								<div class="agile_inner_drop_nav_info">
									<div class="col-sm-6 multi-gd-img1 multi-gd-text ">
										<a href="mens.html"><img src="images/images/cover.jpg" alt=" "/></a>
									</div>
									<div class="col-sm-3 multi-gd-img">
										<ul class="multi-column-dropdown">
											...
											<li><a href="mother_b.php">Mother's Bouquet</a></li>
...
<div class="page-head_agile_info_w3l">
		<div class="container">
			<h3>Simple <span>Bouquet  </span></h3>
			<!--/w3_short-->
...
<div class="footer">
	<div class="footer_agile_inner_info_w3l">
		<div class="col-md-3 footer-left">
			<h2><a href="index.html"><span>Bouquet</span>Choc </a></h2>
		...
		<p class="copy-right">2018 &copy NMN Bouquet Choc. All rights reserved | Design by <a href="http://w3layouts.com/">Aina</a></p>
	</div>
</div>
<!-- //footer -->
