...
<div class="ban-top">
    ...
    if($_SESSION["capaian"] == 1) { ?>
					...
					<li class=" menu__item"><a class="menu__link" href="user_data.php">User Data</a></li>
						<li class="active menu__item menu__item--current"><a class="menu__link" href="view_product.php">Product<span class="sr-only">(current)</span></a></li>
...
<!-- Modal2 -->
				...
				<!-- Modal content-->
								...
								<div class="clearfix"></div>
<br>												
<center><table border="4" bordercolor="pink">
<thead>
     <th>NO</th><th>PRODUCT CODE</th><th>PRODUCT NAME</th><th>
     PRODUCT DESCRIPTION</th><th>PRODUCT PRICE</th><th>PRODUCT PHOTO</th>
     <th>QUANTITY</th><th>UPDATE</th><th>DELETE</th>
</thead>
<tbody>
	<?php
	$i = 0;
...
?>
    ...
    <tr>
       ...
       <td><img width="100" height="100" src="images/images/<?= $row['product_photo']; ?>"></td> 
       <td><?= $row['quantity']; ?></td>
       <td><a href="update_product.php?id=<?php echo $row['id'];?>"><center><img src="images/images/update.png" width="30" height="30"></center></a></td>
       <td><a href="delete_product.php?id=<?php echo $row['id'];?>"
       onclick="return confirm('Adakah anda ingin padam produk <?php echo $row['product_name']; ?>?')"
       ><center><img src="images/images/delete.png" width="30" height="30"></center></a></td>
    </tr>
<?php
    }
?>
