...
if(isset($_POST["login"])){
    ...
    $sql = "SELECT * FROM pengguna WHERE login ='$login' AND "
    ...
    //echo $rows; return;
    if($rows == 0) // if did not find login and pass
        return header("location: index.php?err=true"); //go to page index
    session_start();
    $_SESSION['login'] = $login;
    $_SESSION['capaian'] = $data["capaian"];
    header("location: indexlog.php"); //jumpa into main indexlog
}
?>
...
<div class="header" id="home">
	<div class="container">
		<ul>
			...
			<li> <a href="register.php" ><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Sign Up </a></li>
...
<?php
            if(isset($_GET["err"])){
            ?>
             <div id="error" style="background: red;">(Please make sure your password/login is correct)<br></div>
            <?php }
                ?> 
            </center></h3>
<!-- //header -->
							...
							<ul class="dropdown-menu multi-column columns-3">
								<div class="agile_inner_drop_nav_info">
									<div class="col-sm-6 multi-gd-img1 multi-gd-text ">
										<a href="simple_b.php"><img src="images/bakeri.jpg" alt=" "/></a>
									</div>
					...
					<div class="modal-header">
						...
						<h3 class="agileinfo_sign">Sign In <span>Now</span></h3>
							...
							<input type="submit" value="Sign In">
														...
														<div class="clearfix"></div>
														<p><a href="register.php"  data-target="" > Don't have an account?</a></p>
