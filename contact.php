	...
	<div class="header-bot_inner_wthreeinfo_header_mid">
		...
		<!-- header-bot -->
			<div class="col-md-4 logo_agile">
				<h1><a href="index.html"><span>Nini</span>Cupcake<i class="" aria-hidden="true"></i></a></h1>
			</div>
        <!-- header-bot -->
		  ...
		  <div class="contact-grid-agile-w3s">
				<div class="col-md-4 contact-grid-agile-w3">
						<div class="contact-grid-agile-w31">
							...
							<h4>Address</h4>
							<p>No J7, Bangunan MDB, <span>Jalan Syed Sheikh 09100, Baling, Kedah.</span></p>
						</div>
					</div>
					<div class="col-md-4 contact-grid-agile-w3">
						<div class="contact-grid-agile-w32">
							...
							<h4>Call Us</h4>
							<p>019-4504959<span>+0432318450</span></p>
						</div>
					</div>
					<div class="col-md-4 contact-grid-agile-w3">
